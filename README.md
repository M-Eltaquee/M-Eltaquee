...
- **Query & Modelling:** SQL, DAX, Power Query M
- **Analytical Domains:** Commercial Analysis, Pricing & Margin Modelling, Revenue Forecasting, Supply Chain Performance

---

## 📈 Currently Building

Working through an **Advanced Power BI Developer Program** (Microsoft PL-300 track):
Advanced Data Modeling · Advanced DAX · Power Query & M · Advanced Analytics · Dashboard Design (UX/UI) · Power BI Service · Performance Optimization
